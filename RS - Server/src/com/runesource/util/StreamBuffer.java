...
public abstract class StreamBuffer {
	...
	public static final class OutBuffer extends StreamBuffer {
		 ...
		 *            the value
		 */
		public void writeHeader(SecureCipher cipher, int value) {
			writeByte(value + cipher.nextValue());
		}
		 ...
		 *            the value
		 */
		public void writeVariablePacketHeader(SecureCipher cipher, int value) {
		 ...
		 *            the value
		 */
		public void writeVariableShortPacketHeader(SecureCipher cipher, int value) {
			writeHeader(cipher, value);
			lengthPosition = buffer.writerIndex();
			writeShort(0);
		}
